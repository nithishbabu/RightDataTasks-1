...
//	task-6
	 ...
	 {
		 ConnectionDetails properties = queryBody.getCd();
	  String query = queryBody.getQuery();
	 List<List<Object>> tableDataList = service.getTableData(properties, query);
...
//	task-7
	 ...
	 {
	 List<TableType> viewsAndTables = service.getTablesAndViewsByPattern(bodyPattern.getCd(),
